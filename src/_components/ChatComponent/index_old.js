...
import "./index.css";
import { ChatSend } from "../../core/services/chatcomponent.service"
...
class ChatComponent extends Component {
    ...
    chatSubmit = (event) => {
        ...
        if (this.state.input) {
            ...
            let [app_id, member_id] = [this.props.app, this.props.user.sesuser._ses.sub];
            let obj = {
...
export default (connect(setStateToProps))(ChatComponent);